...
\section{Validation} 
The final step of the study concerned validation. The developed methods must had to be validated in order to be able to evaluate its performance. The validation was performed on a sample of chosen cases, for which the answer was known.
