\chapter{Method}
Given the aim of this project, we now present the methodology. We then present three selected cases that are the focus of this project.
...
The second data set consists of 103202 NetFlow records collected during December 2016 to Mars 2017. This data set includes 10091 IP addresses but is far more sparse with \textit{Gh0st}s, containing only 32 identified RAT controllers. 
