...
\vspace*{.1cm}
    ...
    \wordexpl{Exploit}{Software, data or sequence of commands that takes advantage of a vulnerability to cause damage or other unwanted behaviour in a computer software or hardware.}
    ...
    \wordexpl{Threat actor}{An entity that imposes a threat towards another entity. In this context, the threat refers to an exploit.}
    ...
    \wordexpl{Vertex}{A node in a graph or a point in a network topology from and/or to which edges are connected. Vertices are and edges are the two basic classes of units in a graph.}
